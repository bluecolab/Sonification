...
def write_to_midifile(data, track_type='single', file_name = "output.mid"):
    """
    data: list of tuples of x, y coordinates for pitch and timing
...
def play_midi_from_data(input_data, key=None, number_of_octaves=4, track_type='single', file_name = "output.mid"):
    """
    ...
    memfile = write_to_midifile(data, track_type, file_name)
